    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btnLogin.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                boolean isLoggedIn = dbHelper.checkUser(etUsername.getText().toString(), etPwd.getText().toString());
                if(isLoggedIn){
                    Intent intent = new Intent(ActivityLogin.this, ActivityTracker.class);
